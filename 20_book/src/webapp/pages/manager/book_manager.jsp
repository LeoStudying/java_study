...
<head>
    ...
    <%@ include file="/src/webapp/pages/common/head.jsp" %>
...
<div id="header">
    ...
    <%-- 静态包含 manager管理模块的菜单  --%>
    <%@include file="/src/webapp/pages/common/manager_menu.jsp" %>
...
<div id="main">
    ...
    <%--静态包含分页条--%>
    <%@include file="/src/webapp/pages/common/page_nav.jsp" %>
...
<%--静态包含页脚内容--%>
<%@include file="/src/webapp/pages/common/footer.jsp" %>
