...
1. **spinlock**
   ...
   public class SpinLockDemo {
       public static void main(String[] args) {
           com.leo.juc.lock.SpinLockDemo spinLockDemo = new com.leo.juc.lock.SpinLockDemo();
           new Thread(() -> {
               spinLockDemo.mylock();
               try {
                   TimeUnit.SECONDS.sleep(3);
...
3. 代码示例：
   ...
   import com.leo.juc.conditionThread.CountryEnum;import java.util.concurrent.CountDownLatch;
   import java.util.concurrent.TimeUnit;
